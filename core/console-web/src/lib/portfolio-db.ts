  ...
  const projects: ProjectSummary[] = [
    {
      ...
      path: `${ACTIVE_ROOT}/waqam-project`,
      roadmapFile: `${ACTIVE_ROOT}/waqam-project/ROADMAP.md`,
      priority: "prio1",
      ...
      documents: [
        { label: "Roadmap", fileUri: `file://${ACTIVE_ROOT}/waqam-project/ROADMAP.md`, fileName: "ROADMAP.md" },
        { label: "Studenten-Pitch DE", fileUri: `file://${ACTIVE_ROOT}/waqam-project/projekt_pitch_studenten_de.md`, fileName: "projekt_pitch_studenten_de.md" },
        { label: "Paket 1: Portfolio", fileUri: `file://${ACTIVE_ROOT}/waqam-project/paket1_sap_ai_portfolio.md`, fileName: "paket1_sap_ai_portfolio.md" },
        { label: "Paket 2: Stochastik", fileUri: `file://${ACTIVE_ROOT}/waqam-project/paket2_stochastik_risiko.md`, fileName: "paket2_stochastik_risiko.md" },
        { label: "Paket 3: Board Use Case", fileUri: `file://${ACTIVE_ROOT}/waqam-project/paket3_use_case_simulation.md`, fileName: "paket3_use_case_simulation.md" },
        { label: "Störungs-Handbuch", fileUri: `file://${ACTIVE_ROOT}/waqam-project/stoerung_manipulation_handbuch.md`, fileName: "stoerung_manipulation_handbuch.md" },
      ],
      milestones: [
        { id: "m1", title: "Gate 1: Studenten-Pitch & Rollen vergeben", targetDate: "27.07.2026", status: "in_progress", fileName: "projekt_pitch_studenten_de.md", fileLink: `file://${ACTIVE_ROOT}/waqam-project/projekt_pitch_studenten_de.md` },
        { id: "m2", title: "Gate 2A: Paket 1 SAP AI Portfolio & Scoping", targetDate: "28.07.2026", status: "planned", fileName: "paket1_sap_ai_portfolio.md", fileLink: `file://${ACTIVE_ROOT}/waqam-project/paket1_sap_ai_portfolio.md` },
        { id: "m3", title: "Gate 2B: Paket 2 Stochastik & Simulator-Kopplung", targetDate: "31.07.2026", status: "planned", fileName: "paket2_stochastik_risiko.md", fileLink: `file://${ACTIVE_ROOT}/waqam-project/paket2_stochastik_risiko.md` },
        { id: "m4", title: "Gate 3: Paket 3 WAQAM Board Overhaul & EXT-01", targetDate: "04.08.2026", status: "planned", fileName: "paket3_use_case_simulation.md", fileLink: `file://${ACTIVE_ROOT}/waqam-project/paket3_use_case_simulation.md` },
        { id: "m5", title: "Gate 4: Final Release & Go-Live Briefing Kit", targetDate: "07.08.2026", status: "planned", fileName: "projekt_overview.canvas", fileLink: `file://${ACTIVE_ROOT}/waqam-project/projekt_overview.canvas` },
      ],
    },
    {
      id: "ai-sap-videos",
      title: "AI SAP Videos",
      path: `${ACTIVE_ROOT}/ai-sap-videos`,
      roadmapFile: `${ACTIVE_ROOT}/ai-sap-videos/README.md`,
      priority: "prio2",
      priorityLabel: "🎬 Prio 2",
      deadline: "Mitte/Ende Aug. 2026",
      status: "In Vorbereitung",
      description: "3 Video-Skripte und Aufnahmen für SAP AI Enablement, Demos & YouTube/LinkedIn Clips.",
      dependencies: ["Keine (Autonom)"],
      documents: [
        { label: "Projekt-Ordner", fileUri: `file://${ACTIVE_ROOT}/ai-sap-videos`, fileName: "ai-sap-videos/" },
      ],
      milestones: [
