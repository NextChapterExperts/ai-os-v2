...
export async function getPortfolioData(): Promise<ProjectSummary[]> {
  const projects: ProjectSummary[] = [
    {
      id: "studentenprojekt_v2",
      title: "WAQAM Studentenprojekt V2 (4-Säulen-Modell)",
      path: `${ACTIVE_ROOT}/studentenprojekt_v2`,
      roadmapFile: `${ACTIVE_ROOT}/studentenprojekt_v2/01_ROADMAP.md`,
      priority: "prio1",
      priorityLabel: "🔴 Prio 1 (Höchste)",
      deadline: "LCC-Release V2 · Aktuelle Woche",
      status: "In Arbeit — Säule 1 abgeschlossen",
      description:
        "SAP S/4HANA & BTP: AI Enablement, Governance & Simulation — 4-Säulen-Beratungsmodell für LCC-Readiness.",
      dependencies: ["waqam-doku", "waqamboard", "sap-consultant-package"],
      documents: [
        { label: "Master-Index", fileUri: `file://${ACTIVE_ROOT}/studentenprojekt_v2/README.md`, fileName: "README.md" },
        { label: "Roadmap V2", fileUri: `file://${ACTIVE_ROOT}/studentenprojekt_v2/01_ROADMAP.md`, fileName: "01_ROADMAP.md" },
        { label: "Kundenstory", fileUri: `file://${ACTIVE_ROOT}/studentenprojekt_v2/02_projekt_kundenstory_rahmenkonzept.md`, fileName: "02_projekt_kundenstory_rahmenkonzept.md" },
        { label: "Kickoff-Leitfaden", fileUri: `file://${ACTIVE_ROOT}/studentenprojekt_v2/00_kickoff_studenten_leitfaden.md`, fileName: "00_kickoff_studenten_leitfaden.md" },
        { label: "Rollenverteilung", fileUri: `file://${ACTIVE_ROOT}/studentenprojekt_v2/04_rollenverteilung_studenten.md`, fileName: "04_rollenverteilung_studenten.md" },
        { label: "Bewertungskonzept", fileUri: `file://${ACTIVE_ROOT}/studentenprojekt_v2/07_bewertung_rahmenkonzept.md`, fileName: "07_bewertung_rahmenkonzept.md" },
      ],
      milestones: [
        { id: "s1", title: "Säule 1: Enablement & Abholen", targetDate: "Mo–Di", status: "done", fileName: "saeule_1_enablement/", fileLink: `file://${ACTIVE_ROOT}/studentenprojekt_v2/saeule_1_enablement/00_AP_Uebersicht_Saeule1.md` },
        { id: "s2", title: "Säule 2: KI-Herausforderungen & Blog-Simulator", targetDate: "Mi", status: "in_progress", fileName: "saeule_2_herausforderungen_simulator/", fileLink: `file://${ACTIVE_ROOT}/studentenprojekt_v2/saeule_2_herausforderungen_simulator/00_AP_Uebersicht_Saeule2.md` },
        { id: "s3", title: "Säule 3: SAP-Lösungsarchitektur", targetDate: "Do", status: "planned", fileName: "saeule_3_sap_loesungsarchitektur/", fileLink: `file://${ACTIVE_ROOT}/studentenprojekt_v2/saeule_3_sap_loesungsarchitektur/00_AP_Uebersicht_Saeule3.md` },
        { id: "s4", title: "Säule 4: Use-Case & WAQAM PCS-Simulation", targetDate: "Fr", status: "planned", fileName: "saeule_4_use_case_simulation/", fileLink: `file://${ACTIVE_ROOT}/studentenprojekt_v2/saeule_4_use_case_simulation/00_AP_Uebersicht_Saeule4.md` },
        { id: "s5", title: "LCC-Release V2 — Projektpaket abgabebereit", targetDate: "Fr (Release)", status: "planned", fileName: "01_ROADMAP.md", fileLink: `file://${ACTIVE_ROOT}/studentenprojekt_v2/01_ROADMAP.md` },
      ],
    },
    {
      id: "ai-sap-videos",
    ...
    },
    {
      ...
      dependencies: ["waqam-doku", "studentenprojekt_v2"],
      documents: [
