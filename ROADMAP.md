...
**Stand:** Juli 2026 (aktualisiert 2026-07-27 — Regression Test Suite for Meeting Search & Dispatch, Orchestrator Live Reload & Compute Mode Fallback, Meeting To-Do Search Integration, Wyrd-Key & Odin Legend Popover, Lagebild UI Cleanup & Prompt Dropdown, Standard Prompt Catalog & Refined Intent Router, VIRKI UI Branding, Git Push Automation & Multi-Repo Sync, Document Viewers, WAQAM & Studentenprojekt Restrukturierung, Projekt Zorro)  
