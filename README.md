...
```bash
# Console Skeleton (Next.js :8092) — zum Testen der Platform-Infra
cd core/console-web && npm run dev
# → http://localhost:8092  · Live-Health: /platform

# Orchestrator + MCP-Gateway (Phase-1 Skeleton)
./core/orchestrator/run.sh    # :8091
./core/mcp_gateway/run.sh     # :8097
# Lagebild-Feld → POST /api/dispatch → Orchestrator
